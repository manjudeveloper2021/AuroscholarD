...
public class GradeChangeViewModel extends ViewModel {
    ...
    public GradeChangeViewModel(HomeUseCase homeUseCase, HomeDbUseCase homeDbUseCase, HomeRemoteUseCase homeRemoteUseCase) {
