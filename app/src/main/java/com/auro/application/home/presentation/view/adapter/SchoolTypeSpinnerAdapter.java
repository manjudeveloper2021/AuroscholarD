...
public class SchoolTypeSpinnerAdapter extends ArrayAdapter {
    StateSpinnerItemBinding binding;
    List<SchoolTypeData> list;
    ...
    public SchoolTypeSpinnerAdapter(@NonNull Context context, int resource, List<SchoolTypeData> list, CommonCallBackListner onItemClickState) {
        ...
        binding.StateList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onItemClickState != null) {
                    onItemClickState.commonEventListner(AppUtil.getCommonClickModel(position, Status.SCHHOLTYPE, list.get(position)));
                }
