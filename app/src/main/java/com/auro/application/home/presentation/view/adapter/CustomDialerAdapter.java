...
import com.auro.application.databinding.CustomDialerItemLayoutBinding;
...
public class CustomDialerAdapter extends RecyclerView.Adapter<CustomDialerAdapter.ViewHolder> {
    ...
    @Override
    public CustomDialerAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
