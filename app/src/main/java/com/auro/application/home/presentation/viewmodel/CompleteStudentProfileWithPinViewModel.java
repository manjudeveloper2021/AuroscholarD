...
public class CompleteStudentProfileWithPinViewModel extends ViewModel {
    ...
    public CompleteStudentProfileWithPinViewModel(HomeUseCase homeUseCase, HomeDbUseCase homeDbUseCase, HomeRemoteUseCase homeRemoteUseCase) {
