...
import com.auro.application.core.util.uiwidget.AsteriskPasswordTransformationMethod;
...
public class OtpView extends LinearLayout {
  ...
  private void styleEditTexts(TypedArray styles) {
    ...
    if (length > 0) {
      ...
      int spaceLeft = (int) styles.getDimension(R.styleable.OtpView_space_left, getPixels(0));
      int spaceRight = (int) styles.getDimension(R.styleable.OtpView_space_right, getPixels(0));
      ...
      int hintColor = styles.getColor(R.styleable.OtpView_hint_color, getContext().getColor(R.color.color_light_grey));
