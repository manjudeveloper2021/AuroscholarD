...
public class UserNotRegisterDialog extends Dialog {

    public Activity activity;
    private UserNotRegisteredDialogLayoutBinding binding;
    PrefModel prefModel;
    CommonCallBackListner listner;

    public UserNotRegisterDialog(Activity context, CommonCallBackListner commonCallBackListner) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.inflate(LayoutInflater.from(getContext()), R.layout.user_not_registered_dialog_layout, null, false);
        setContentView(binding.getRoot());
        //setText();
        prefModel = AuroAppPref.INSTANCE.getModelInstance();
        AppStringDynamic.setUserNotRegisterStings(binding);
