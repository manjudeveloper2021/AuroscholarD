package com.auro.application.util.camera;
 ...
 * <p>
 * This work is the evolution of the original Camera3Source from GoogleSamples.
...
public class Camera2Source {
    ...
    private Size getBestAspectPictureSize(android.util.Size[] supportedPictureSizes) {
        float targetRatio = ViewUtil.getScreenRatio(mContext);
        Size bestSize = null;
    ...
    private void setUpCameraOutputs(int width, int height) {
        try {
            ...
            Point displaySize = new Point(ViewUtil.getScreenWidth(mContext), ViewUtil.getScreenHeight(mContext));
            ...
            Size[] outputSizes = ViewUtil.sizeToSize(map.getOutputSizes(SurfaceTexture.class));
            Size[] outputSizesMediaRecorder = ViewUtil.sizeToSize(map.getOutputSizes(MediaRecorder.class));
