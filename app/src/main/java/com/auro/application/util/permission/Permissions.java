...
public class Permissions {
    ...
    public static void check(final Context context, String[] permissions, String rationale,
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            handler.onGranted();
            AppLogger.v("Permission_pradeep","handler.onGranted()");
            log("Android version < 23");
        } else {
            AppLogger.v("Permission_pradeep","else step 1");
            ...
            if (allPermissionProvided) {
                AppLogger.v("Permission_pradeep","else allPermissionProvided step 2");
                handler.onGranted();
                ...
                AppLogger.v("Permission_pradeep","else step 3");
                ...
                if (options != null && options.createNewTask) {
                    ...
                    AppLogger.v("Permission_pradeep","else step 4");
                }
