package com.auro.application.util.utility;
...
public class Camera3Source {
    ...
    private static final String TAG = "MIDemoApp:Camera3Source";
    ...
    public Camera3Source(Activity activity, GraphicOverlay overlay) {
    ...
    public synchronized Camera3Source start() throws IOException {
        if (camera != null) {
            return this;
        }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public synchronized Camera3Source start(SurfaceHolder surfaceHolder) throws IOException {
        if (camera != null) {
            return this;
        }
