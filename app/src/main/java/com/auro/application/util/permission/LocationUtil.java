...
public class LocationUtil {
    ...
    public static boolean isGPSEnabled() {
        LocationManager locationManager = (LocationManager)
                AuroApp.getAppContext().getSystemService(Context.LOCATION_SERVICE);
    ...
    public static void setLocationData(Location location) {
        ...
        if (location != null) {
            try {
                ...
                AuroAppPref.INSTANCE.setStringPref(AppConstant.LOCATION_DATA, getJsonFromLocationModel(locationModel));
            } catch (Exception e) {
                AppLogger.e("setLocationData", e.getMessage());
            }
        } else {
            AuroAppPref.INSTANCE.setStringPref(AppConstant.LOCATION_DATA, "");
        }
    }
    ...
    public static LocationModel getLocationData() {
        ...
        if (isGPSEnabled()) {
            String strJSONResponse = AuroAppPref.INSTANCE.getPrefStringValueNotNull(AppConstant.LOCATION_DATA);
    ...
    public static boolean isLocationAvailable() {
        ...
        return locationModel != null && locationModel.getLatitude() != null && !locationModel.getLatitude().isEmpty();
    }
