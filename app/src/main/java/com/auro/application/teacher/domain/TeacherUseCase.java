...
import com.auro.application.teacher.data.model.response.MyClassRoomStudentResModel;
...
public class TeacherUseCase {
    ...
    private void setValues(MyClassRoomStudentResModel model) {
        try {
            ...
            model.setYear(year);
            AppLogger.e("Date exception", "months--" + month + "-Year-" + month);
        } catch (Exception e) {
    ...
    public ArrayList<KYCDocumentDatamodel> makeAdapterDocumentList(TeacherKycStatusResModel teacherKycStatusResModel) {
        ...
        kyc_one.setDocumentDesc("Supports : JPG, PNG, JPEG");
        ...
        kyc_one.setTeacherKycStatusResModel(teacherKycStatusResModel.getKycDocsData().get(0));
        ...
        kyc_two.setDocumentDesc("Supports : JPG, PNG, JPEG");
        ...
        kyc_two.setTeacherKycStatusResModel(teacherKycStatusResModel.getKycDocsData().get(1));
        ...
        kyc_three.setDocumentDesc("Supports : JPG, PNG, JPEG");
        ...
        kyc_three.setTeacherKycStatusResModel(teacherKycStatusResModel.getKycDocsData().get(2));
        ...
        kyc_four.setDocumentDesc("Supports : JPG, PNG, JPEG");
        ...
        kyc_four.setTeacherKycStatusResModel(teacherKycStatusResModel.getKycDocsData().get(3));
