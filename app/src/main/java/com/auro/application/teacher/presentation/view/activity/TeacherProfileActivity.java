...
public class TeacherProfileActivity extends BaseActivity implements View.OnFocusChangeListener, View.OnTouchListener, View.OnClickListener, CommonCallBackListner {
    ...
    PrefModel prefModel;
    String getschool_id,school_name_id;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        editor.putString("statusopenprofileteacher", "true");
        ...
        binding.autoCompleteTextView1.setAdapter(getEmailAddressAdapter(TeacherProfileActivity.this));
       ...
       binding.txtaddnewschool.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               if (binding.editsearch.getText().toString().isEmpty()){
                   Toast.makeText(TeacherProfileActivity.this, "Please enter school name", Toast.LENGTH_SHORT).show();
               }
               else{
        ...
        binding.addnewschool.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (binding.autoCompleteTextView1.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(TeacherProfileActivity.this, details.getEnter_space_schoolname(), Toast.LENGTH_SHORT).show();
                }
                else{
...
//        }
    ...
    public void callingStudentUpdateProfile() {
        ...
        if (binding.etFullName.getText().toString().isEmpty()){
            Toast.makeText(TeacherProfileActivity.this, details.getPlease_enetr_the_name(), Toast.LENGTH_SHORT).show();
        }

        else if (binding.etFullName.getText().toString().startsWith(" ") || binding.etFullName.getText().toString().isEmpty()){

            Toast.makeText(TeacherProfileActivity.this, details.getEnter_space_name(), Toast.LENGTH_SHORT).show();
        }
        else if (binding.etEmailNumber.getText().toString().isEmpty()){

            Toast.makeText(TeacherProfileActivity.this, details.getPlease_enter_your_emailid(), Toast.LENGTH_SHORT).show();
        }
        else if (!email.matches(emailPattern)){
            Toast.makeText(TeacherProfileActivity.this, details.getPlease_enter_valid_email(), Toast.LENGTH_SHORT).show();

        }
        else if (binding.etEmailNumber.getText().toString().startsWith(" ")&& !binding.etEmailNumber.getText().toString().isEmpty()){

            Toast.makeText(TeacherProfileActivity.this, details.getEnter_space_email(), Toast.LENGTH_SHORT).show();
        }
            ...
            Toast.makeText(TeacherProfileActivity.this, details.getPlease_select_gender(), Toast.LENGTH_SHORT).show();
        }
            ...
            Toast.makeText(TeacherProfileActivity.this, details.getPlease_enter_select_state(), Toast.LENGTH_SHORT).show();
        }
            ...
            Toast.makeText(TeacherProfileActivity.this, details.getPlease_enter_district(), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(TeacherProfileActivity.this, details.getPlease_select_school(), Toast.LENGTH_SHORT).show();

        }
        else if (image_path==null||image_path.equals("")||image_path.equals("null")||image_path.equals(null)){
            Toast.makeText(TeacherProfileActivity.this, details.getUploadProfilePic(), Toast.LENGTH_SHORT).show();
            ...
            String schoolid = teacherProfileModel.getSchool_id();
            ...
            String getschool = teacherProfileModel.getSchool_id();
          //  AppLogger.v("SaveProfile",schoolName+"school -- state id"+stateCode+" -- district"+districtCode);
           ...
           // if (validationModel.isStatus()) {
            ...
            updateTeacher(stateCode,districtCode,getschool);
          //  } else {
    ...
    private void updateTeacher(String state, String district, String school) {
       String fullname = binding.etFullName.getText().toString();
        String email = binding.etEmailNumber.getText().toString();
        String gender = binding.etGenderDrop.getText().toString();
        ...
        String mobileno = binding.etPhoneNumber.getText().toString();
        String languageid = ViewUtil.getLanguageId();
        RequestBody fullname_c = RequestBody.create(MediaType.parse("text/plain"), fullname);
        RequestBody email_c = RequestBody.create(MediaType.parse("text/plain"), email);
        RequestBody gender_c = RequestBody.create(MediaType.parse("text/plain"), gender);
        RequestBody userid_c = RequestBody.create(MediaType.parse("text/plain"), userid);
        RequestBody username_c = RequestBody.create(MediaType.parse("text/plain"), username);
        RequestBody mobileno_c = RequestBody.create(MediaType.parse("text/plain"), mobileno);
        RequestBody languageid_c = RequestBody.create(MediaType.parse("text/plain"), languageid);
        RequestBody no_data = RequestBody.create(MediaType.parse("text/plain"), "");
        RequestBody state_id = RequestBody.create(MediaType.parse("text/plain"), state);
        RequestBody district_id = RequestBody.create(MediaType.parse("text/plain"), district);
        RequestBody school_id = RequestBody.create(MediaType.parse("text/plain"), school);
        ...
        RemoteApi.Companion.invoke()
                .updateTeacherProfileApi(userid_c,fullname_c,username_c,mobileno_c,email_c,gender_c,no_data,state_id,district_id,school_id,languageid_c,no_data,no_data,lFile)
                        ...
                        try {
                            ...
                            if (response.code()==400){
                                ...
                                if (status.equalsIgnoreCase("success")) {
                                    Toast.makeText(TeacherProfileActivity.this, msg.toString(), Toast.LENGTH_SHORT).show();
                                    Intent i = new Intent(TeacherProfileActivity.this, HomeActivity.class);
                                    i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                    startActivity(i);
                                }
                            }
                            else {
                                Toast.makeText(TeacherProfileActivity.this, response.errorBody().toString(), Toast.LENGTH_SHORT).show();
                                Log.d(TAG, "onImageerrorResponse: " + response.errorBody().toString());
                                //  showSnackbarError(response.message());
                            }
                        } catch (Exception e) {
                            Toast.makeText(TeacherProfileActivity.this, details.getInternetCheck(), Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onFailure(Call<StudentResponselDataModel> call, Throwable t) {
                        Toast.makeText(TeacherProfileActivity.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
...
//                break;
    ...
    private void handleProgress(int status, String message) {
        switch (status) {
            ...
            case 5:
                ...
                showSnackbarError(details.getSuccess_fully_save(), Color.parseColor("#4bd964"));
    ...
    public void setRecycleView() {
        ...
        mProfileClassAdapter = new com.auro.application.teacher.presentation.view.adapter.ProfileScreenAdapter(viewModel.teacherUseCase.selectClass(""), this, this);
        binding.recycleViewclass.setAdapter(mProfileClassAdapter);

        //for subject recycle view
        GridLayoutManager gridlayout2 = new GridLayoutManager(this, 2);
        ...
        mProfileSubjectAdapter = new ProfileScreenAdapter(viewModel.teacherUseCase.selectSubject(""), this, this);
    ...
    public void setDataOnUi() {
        ...
        try {
            ...
            district_code = model.getDistrict_name();
            getAllDistrict(state_Code);
...
//        progress.show();
    ...
    private void addNewSchool(String state_id, String district_id, String search)
    {
        ...
        ProgressDialog progress = new ProgressDialog(TeacherProfileActivity.this);
        progress.setTitle(details.getProcessing());
        progress.setMessage(details.getProcessing());
        progress.setCancelable(true); // disable dismiss by tapping outside of the dialog
        progress.show();
                ...
                .enqueue(new Callback<AddNewSchoolResModel>() {
                    ...
                    public void onResponse(Call<AddNewSchoolResModel> call, Response<AddNewSchoolResModel> response) {
                        if (response.code()==400){
                            ...
                            Toast.makeText(TeacherProfileActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                            ...
                            progress.dismiss();
                            Toast.makeText(TeacherProfileActivity.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                            ...
                            if (response.body().getSchools()!=null||!response.body().getSchools().isEmpty()) {
                                ...
                                if (districtList != null || !districtList.isEmpty()) {
                                    ...
                                    if (districtList != null && districtList.size()!=0) {
                                        ...
                                        Toast.makeText(TeacherProfileActivity.this, details.getNo_data_found(), Toast.LENGTH_SHORT).show();                                    }
    ...
    public void addDropDownState(List<StateData> stateList) {
        ...
        com.auro.application.home.presentation.view.adapter.StateSpinnerAdapter stateSpinnerAdapter = new com.auro.application.home.presentation.view.adapter.StateSpinnerAdapter(this, android.R.layout.simple_dropdown_item_1line, stateList, this);
    ...
    public void addDropDownDistrict(List<DistrictData> districtList) {
        ...
        com.auro.application.home.presentation.view.adapter.DistrictSpinnerAdapter districtSpinnerAdapter = new com.auro.application.home.presentation.view.adapter.DistrictSpinnerAdapter(this, android.R.layout.simple_dropdown_item_1line, districtList, this);
    ...
    public void addDropDownSchool(List<SchoolData> districtList) {
        AppLogger.v("StatePradeep", "addDropDownState    " + districtList.size());
        com.auro.application.home.presentation.view.adapter.SchoolSpinnerAdapter districtSpinnerAdapter = new SchoolSpinnerAdapter(this, android.R.layout.simple_dropdown_item_1line, districtList, this);
    ...
    private void getProfile()
    {
        ...
        String  usermobilenumber = prefs.getString("usermobilenumber", "");
                ...
                .enqueue(new Callback<MyProfileResModel>()
                {
                    ...
                    public void onResponse(Call<MyProfileResModel> call, Response<MyProfileResModel> response)
                    {
                        if (response.isSuccessful()) {
                            ...
                            if (message.equals("Success : Profile Show Successfully")){
                                binding.etFullName.setText(response.body().getTeacherName());
                                binding.etPhoneNumber.setText(response.body().getMobileNo());

                                binding.etGenderDrop.setText(response.body().getGender());
                                binding.etState.setText(response.body().getState_name());
                                binding.etDistict.setText(response.body().getDistrict_name());
                                binding.etSchoolName.setText(response.body().getSchool_name());

                            }

                            else{
                            binding.etPhoneNumber.setText(usermobilenumber);
                            }
